 ...
 */
function createComponents(onImageClick?: (src: string, alt: string) => void): Components {
	return {
...
export function MarkdownContent({ content, className }: MarkdownProps) {
	...
	const components = useMemo(() => createComponents(handleImageClick), [handleImageClick]);
